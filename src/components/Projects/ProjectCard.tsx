...
export default function ProjectCard({ project }: { project: ProjectType }) {
  return (
    <>
      <div
        key={project.title}
        className="flex flex-col p-6 max-w-lg text-center bg-white rounded-lg border border-gray-100 dark:border-gray-600 xl:p-8 dark:bg-gray-700 shadow-lg hover:shadow-2xl transition hover:scale-105"
      >

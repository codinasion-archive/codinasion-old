  ...
  return (
    <>
      ...
      >
        <div>
          <Image
            className="inline-block h-28 w-28 rounded-xl ring-2 ring-white dark:ring-gray-900 m-1"
        ...
        <div className="py-4">
          <p className="text-md font-medium text-gray-900 truncate dark:text-white">
            {new Date(github_user.last_clicked_at).toLocaleDateString("en-US", {
              year: "numeric",
              month: "long",
              day: "numeric",
            })}
        ...
        <div className="py-4 space-y-4 col-span-2 md:col-span-1">
          ...
          <button className="btn w-full p-1 px-5 rounded bg-transparent hover:bg-red-100 border border-red-500">
